...
mixin MessageStateMixin {
  ...
  void showError(String message) {
    //untracked variavel vai ser alterada sem notificar
...
//mixin para view ( on que so pode ser add em esse tipo de classe)
mixin MessageViewMixin<T extends StatefulWidget> on State<T> {
  //effect do signal escuta
